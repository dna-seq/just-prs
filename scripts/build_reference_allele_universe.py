...
def main() -> int:
    ...
    parser.add_argument("--genome-build", default="GRCh38", help="Genome build (only GRCh38 is published today).")
    ...
    out = cache / "percentiles" / "reference_allele_universe.parquet"
    ...
    if args.push:
        ...
        print(f"Uploading to {DEFAULT_HF_CATALOG_REPO}/{HF_REFERENCE_PREFIX}/{REFERENCE_ALLELE_UNIVERSE_FILE} ...")
        push_reference_allele_universe(out)
        print("UPLOADED")
