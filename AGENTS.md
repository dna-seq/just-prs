...
- `reflex-mui-datagrid` lazy grids own row-selection handling internally; customize by overriding `handle_lf_grid_row_selection`, and use supported `detail_columns`/badge props for foldable detail panels.
